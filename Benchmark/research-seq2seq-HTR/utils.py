...
def set_dataset_location(data_location_train, data_location_val, data_location_test="IAM_REAL/"):
    loadData.data_location_train = data_location_train
    loadData.data_location_val = data_location_val
    loadData.data_location_test = data_location_test
