#!/bin/bash
#SBATCH --job-name=character_patchloss_for_ganwriting
#SBATCH --ntasks=1
...
tar xfk /scratch/qi69dube/dataset.tar.gz -C /scratch/qi69dube/
# -1 stands for: continue with the last saved-model
python3 main_run.py -1 save_weights_character imgs_character --character_patch_loss
